  ...
  return (
    ...
    >
      ...
      <Tab.Screen
        ...
        options={{
          headerTitle: 'Instrument Registration',
          tabBarIcon: ({ focused }) => (
            <TabIcon icon="➕" label="Register" focused={focused} />
          ),
        }}
      />
      <Tab.Screen 
        ...
        options={{
          headerTitle: 'AI Legal Metrology Advisor',
          tabBarIcon: ({ focused }) => (
            <TabIcon icon="🤖" label="AI Advisor" focused={focused} />
          ),
        }}
      />
      <Tab.Screen 
