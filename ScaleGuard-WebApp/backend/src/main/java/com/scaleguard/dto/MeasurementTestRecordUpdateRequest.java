...
public class MeasurementTestRecordUpdateRequest {
    ...
    public MeasurementTestRecordUpdateRequest() {
    }

    public MeasurementTestRecordUpdateRequest(BigDecimal standardValue, BigDecimal observedValue, String unit, String remarks) {
