...
public class VerificationApplicationCreateRequest {
    ...
    public VerificationApplicationCreateRequest() {
    }

    public VerificationApplicationCreateRequest(Long instrumentId, ApplicationType applicationType,
