...
export const CreateInstrument = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/instruments', { state: { message: 'Instrument registered successfully.' } });
    } catch (err) {
      ...
      setError(
        err.response?.data?.message ||
          err.message ||
          'Failed to register instrument. Please check inputs.'
      );
    } finally {
      setSubmitting(false);
    }
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-600">
                Register a weighing or measuring instrument belonging to your business for verification and compliance.
              </p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  placeholder="e.g. Digital Platform Scale 500kg"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="e.g. SN-AVT-2024-0099"
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="md:col-span-2">
                <label className="block text-xs font-semibold text-slate-700 uppercase tracking-wider mb-1">
                  Installation / Shop Floor Location *
                </label>
                <input
                  type="text"
                  name="location"
                  ...
                  onChange={handleChange}
                  placeholder="e.g. Warehouse Bay 3, Production Line A, Retail Checkout Counter 2"
                  className={`w-full px-3.5 py-2.5 rounded-lg border text-sm focus:outline-none focus:ring-2 ${
          ...
          <div className="flex items-center justify-end space-x-3 pt-2">
            ...
            >
              ...
              {submitting ? 'Registering Instrument...' : 'Register Instrument'}
            </button>
          </div>
        </form>
      </main>
